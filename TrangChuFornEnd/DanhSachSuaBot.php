...
<body>
    <div class="container">
        ...
        <div >
            <img src="images/bannerSuaBot.jpg" alt="Banner 1">
        </div>
        <h1>Danh Sách Sản Phẩm Sữa Bột</h1>
        ...
        <div class="product-grid">
            ...
            $db = "SELECT sua.Masua as masua, sua.Hinh as hinh, sua.Tensua as Tensua, sua.Trongluong as trongluong, sua.Dongia as dongia, 
                    ...
                    WHERE loaisua.Tenloai = 'Sữa bột'";

            $result = mysqli_query($conn, $db);

            if (mysqli_num_rows($result) == 0) {
                echo "<p style='text-align: center;'>Không có sản phẩm sữa bột nào</p>";
            } else {
