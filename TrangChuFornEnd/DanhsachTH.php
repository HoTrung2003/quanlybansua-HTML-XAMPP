  ...
  <head>
    ...
    <style type="text/css">
      ...
      .banner-slideshow {
        ...
        height: 300px; /* Đặt chiều cao khung chứa */
  ...
  <body>
    <div class="container">
      ...
      <div class="banner-slideshow">
        <div class="slides">
            <img src="images/banner4TH.jpg" alt="Banner 3">
            <img src="images/banner1TH.jpg" alt="Banner 1">
            <img src="images/banner2TH.jpg" alt="Banner 2">
            <img src="images/banner3TH.jpg" alt="Banner 3">
        </div>
      </div>
      
      <h1>Danh Sách Sản Phẩm Hãng TH-True-Milk</h1>
      ...
      <div class="product-grid">
        ...
        $db = "SELECT sua.Masua as masua, sua.Hinh as hinh, sua.Tensua as Tensua, sua.Trongluong as trongluong, sua.Dongia as dongia, 
                ...
                WHERE hangsua.Tenhang = 'Th_True_Milk'";

        $result = mysqli_query($conn, $db);

        if (mysqli_num_rows($result) == 0) {
            echo "<p style='text-align: center;'>Không có sản phẩm nào của hãng TH-True-Milk</p>";
        } else {
