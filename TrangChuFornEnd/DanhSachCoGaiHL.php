...
<html>
  <head>
    <meta charset="utf-8">
    <title>Danh sách sản phẩm TH-True-Milk</title>
    <?php
    ...
    <style type="text/css">
      ...
      .slides img {
          ...
          height: 450px; /* Chiều cao mỗi ảnh */
    ...
    <div class="container">
      ...
      <div class="banner-slideshow">
        <div class="slides">
            ...
            <img src="images/banner1GHL.jpg" alt="Banner 1">
            <img src="images/banner2GHL.jpg" alt="Banner 2">
            <img src="images/banner3GHL.jpg" alt="Banner 3">
            <img src="images/banner4GHL.jpg" alt="Banner 4">
        </div>
      </div>
      
      <h1>Danh Sách Sản Phẩm Hãng Cô Gái Hà Lan</h1>
      ...
      <div class="product-grid">
        ...
        $db = "SELECT sua.Masua as masua, sua.Hinh as hinh, sua.Tensua as Tensua, sua.Trongluong as trongluong, sua.Dongia as dongia, 
                ...
                WHERE hangsua.Tenhang = 'Cô Gái Hà Lan'";

        $result = mysqli_query($conn, $db);

        if (mysqli_num_rows($result) == 0) {
            echo "<p style='text-align: center;'>Không có sản phẩm nào của hãng Cô Gái Hà Lan</p>";
        } else {
