...
<html>
  <head>
    <meta charset="utf-8">
    <title>Danh sách sản phẩm Abbott</title>
    <?php
  ...
  <body>
    <div class="container">
      ...
      <div class="banner-slideshow">
        <div class="slides">
            <img src="images/banner1ABG.jpg" alt="Banner 1">
            <img src="images/banner3ABG.jpg" alt="Banner 3">
            <img src="images/banner4ABG.jpg" alt="Banner 4">
            <img src="images/banner2ABG.jpg" alt="Banner 2">
        </div>
      </div>
      <h1>Danh Sách Sản Phẩm Hãng Abbott</h1>
      ...
      <div class="product-grid">
        ...
        $db = "SELECT sua.Masua as masua, sua.Hinh as hinh, sua.Tensua as Tensua, sua.Trongluong as trongluong, sua.Dongia as dongia, 
                ...
                WHERE hangsua.Tenhang = 'Abbott'";

        $result = mysqli_query($conn, $db);

        if (mysqli_num_rows($result) == 0) {
            echo "<p style='text-align: center;'>Không có sản phẩm nào của hãng Abbott</p>";
        } else {
