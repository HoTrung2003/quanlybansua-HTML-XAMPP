...
<head>
    <meta charset="utf-8">
    <title>Danh sách sản phẩm Sữa Đặc</title>
    <?php
...
<body>
    <div class="container">
        ...
        <div>
            <img style="width: 1200px;height: 400px;" src="images/bannerSuaDac.jpg" alt="Banner 1">
        </div>
        <h1>Danh Sách Sản Phẩm Sữa Đặc</h1>
        ...
        <div class="product-grid">
            ...
            $db = "SELECT sua.Masua as masua, sua.Hinh as hinh, sua.Tensua as Tensua, sua.Trongluong as trongluong, sua.Dongia as dongia, 
                    ...
                    WHERE loaisua.Tenloai = 'Sữa đặc'";

            $result = mysqli_query($conn, $db);

            if (mysqli_num_rows($result) == 0) {
                echo "<p style='text-align: center;'>Không có sản phẩm sữa đặc nào</p>";
            } else {
